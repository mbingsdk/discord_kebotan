...
import useGsapLogoAnimation from './hooks/useGsapLogoAnimation'
...
export default function App({ children }) {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between stu bg-base-200 pb-16 pt-16">
      ...
      {/* DOCK MENU BOTTOM */}
      <div className="btm-nav fixed bottom-0 left-0 w-full bg-base-300 z-50 border-t">
        {DockMenu()}
      </div>
    </div>
  )
